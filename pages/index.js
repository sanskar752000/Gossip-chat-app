...
/* This unusual include style is because the AblyChatComponent can only be run inside the user's browser. 
 It connects using WebSockets and isn't suitable for Server Side Rendering with Vercel. By default, 
 Next.js attempts to render everything on the server side, so by including the component using a dynamic() call, 
 we can tell Next.js not to render this during the build process, where it would throw errors because 
 it can't connect to the APIs that it needs to function. */
  ...
  return (
    <div className="container">
      ...
      <footer>
        ...
        <a href="https://github.com/sanskar752000/Gossip-chat-app" className="github-corner" aria-label="View source on GitHub">
